...
<body>
	<form:form>
		...
		<p><label>비밀번호 확인: <input id="confirmPassword" type="password"></label></p>
		<c:set var="now" value="<%=LocalDateTime.now() %>"/>
		<p><label>가입일: <input id="regdate" type="date" value='<tf:formatDateTime value="${now }" pattern="yyyy-MM-dd"/>' readonly="readonly"></label></p>
	</form:form>
